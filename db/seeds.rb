...
PaintingClass.create!(date: DateTime.now+97, max_capacity: 20, price: 30, painting: p2)
PaintingClass.create!(date: DateTime.now+121, max_capacity: 20, price: 30, painting: p3)